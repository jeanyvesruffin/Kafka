...
* Event: 
    * Description d'une action (métier ex: passage d'une commande, d'un payement, via un site e-commerce)
...
* Producer (ecriture)
    * Application cliente aui écrit des données
...
Exemple de cluster partitionné

...
- [x] `fr.orderflow.payment.messaging.KafkaEventPaymentPublisher` et `KafkaTopicsPaymentConfig` pour les topics
  `payments.*`
- [x] Compensation limitée aux réservations de la commande annulée (`stock_reservation`)
